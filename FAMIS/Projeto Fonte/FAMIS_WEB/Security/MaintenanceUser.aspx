<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MaintenanceUser.aspx.cs" Inherits="Security_MaintenanceUser" %>
...
<div id="framecontent">
    ...
    <div id="toplogin">
    <ul>
    	<li><b><asp:Label ID="lblLogin" runat="server" Text="Edinei"></asp:Label></b></li>
