<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Timesheet.ascx.cs" Inherits="Controles_UserAppointment" %>
<style type="text/css">
        .style1
        {
            height: 33px;
...
&nbsp;&nbsp;&nbsp;&nbsp; <b>STOP</b>
                                ...
                                <td>
                                    <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/imagens/TimeSheet/client.png"
