<%@ control language="C#" autoeventwireup="true" inherits="Controles_TESTENEWPAGE, App_Web_0mnnnkzl" %>
...
<head id="Head1">SARAIVA - SEGMENTAÇÃO</title>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td id="formtitulo"><img src="../Imagens/div_titulo.gif" alt="" align="middle"/>Segurança | Usuário | Manutenção</td>
  </tr>
  <tr>
    <td>
    <table width="99%" align="right" border="0" cellspacing="3" cellpadding="0" id="formfont">
        ...
        <tr>
          <td width="25%">Nome do Usuário:</td>
...
******************************************************************************** -->        
    <div id="gridform">
        ...
        Width="100%" AllowPaging="false" CellPadding="4">
          ...
          <asp:BoundField HeaderText="Código" HeaderStyle-HorizontalAlign="Center" HeaderStyle-CssClass="grid_tittle_div" HeaderStyle-Width="10%">
