<%@ control language="C#" autoeventwireup="true" inherits="Controles_Geospecs, App_Web_l0urcdma" %>
<!-- Begin do Controle -->
<head><title></title>
        ...
        <div>
            ...
            <div id="LeadDiv" class="ContentDiv" >
                ...
                <table id="LeadTable" runat="server" width="300px" cellpadding="0" cellspacing="3" style="border-bottom-color: #00008b;" align="center"> 
                    ...
                    <tr>
                        <td colspan="2" align="left">
                            <asp:DropDownList ID="DropRegion" runat="server" Height="22px" Width="300px"></asp:DropDownList>
                        </td>                    
                        <td colspan="2" align="left">
